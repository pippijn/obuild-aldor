--* From hemmecke@risc.uni-linz.ac.at  Mon May  8 16:04:45 2000
--* Received: from kernel.risc.uni-linz.ac.at (root@kernel.risc.uni-linz.ac.at [193.170.37.225])
--* 	by nagmx1.nag.co.uk (8.9.3/8.9.3) with ESMTP id QAA15331
--* 	for <ax-bugs@nag.co.uk>; Mon, 8 May 2000 16:04:32 +0100 (BST)
--* Received: from deneb.risc.uni-linz.ac.at (deneb.risc.uni-linz.ac.at [193.170.37.113])
--* 	by kernel.risc.uni-linz.ac.at (8.9.2/8.9.2/Debian/GNU) with ESMTP id RAA31877;
--* 	Mon, 8 May 2000 17:06:48 +0200 (CEST)
--* Message-ID: <XFMail.000508170648.hemmecke@risc.uni-linz.ac.at>
--* X-Mailer: XFMail 1.3 [p0] on Solaris
--* X-Priority: 3 (Normal)
--* Content-Type: text/plain; charset=us-ascii
--* Content-Transfer-Encoding: 8bit
--* MIME-Version: 1.0
--* Date: Mon, 08 May 2000 17:06:48 +0200 (MET DST)
--* Sender: hemmecke@risc.uni-linz.ac.at
--* From: Ralf.Hemmecke@risc.uni-linz.ac.at
--* To: ax-bugs@nag.co.uk
--* Subject: [2] Using package in category defaults
...
--:                    .......................................^
--: [L12 C40] #1 (Error) There are no suitable meanings for the operator
`coerce'.
...
--:                    ........................^
--: [L31 C25] #2 (Error) There are no suitable meanings for the operator
`coerce'.
--:    The possible types of the left hand side are:
--:           -- String
--: 
