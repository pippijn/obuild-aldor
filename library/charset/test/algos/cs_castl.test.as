...
local TESTSTUB == TestUpdatableTriangularizationAlgorithmType( DPR, RT, CoherentAutoreducedSetTools( DPR, RT, BasicSetSortedTools( DPR, RT ) ) );

TestCoherentAutoreducedSetTools : TestCaseType with {

#include "cs_resum.test.signatures.as"
#include "cs_trang.test.signatures.as"
#include "cs_castl.test.signatures.as"
	...
	triangularizeTester!( [ var101 ], [ var101 ], [ -1, 1 ] );
	...
	triangularizeTester!( [ var101+var201*var201+var300*var300, var201*var201*var100, var300 ], [ var201*var201*var100, var101*var100, var300 ], [ -var300*var100*var100, -var100, var100, -var300*var100, 1, -1, 2*var201*var100, -2*var201*var100 ] );
	...
	triangularizeTester!( [ var310+var200, var301 ], [ -var201, var310+var200, var301 ], [ 1, -1 ] );
