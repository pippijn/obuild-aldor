...
local PR    == DistributedMultivariatePolynomial1( DIDOM, DVARS, EXP);
local DPR   == DifferentiallyExtendedPolynomialRing( DIDOM, VARS, DVARS, PR );


TestDifferentiallyExtendedPolynomialRing0 : TestCaseType with {

#include "cs_dprt.test.signatures.as"
#include "cs_depr0.test.signatures.as"
	...
	local OEXP == SortedListExponent( ODVARS );
	local OPR    == DistributedMultivariatePolynomial1( DIDOM, ODVARS, OEXP);
