...
local ORDER == DifferentialVariableOrderlyEliminationOrderTools;
...
local  DVARSLIST == {
    ...
    [ x, xs, xt, xss, xst, xtt, y, ys, yt, yss, yst, ytt ]$(List DVARS);
}



TestOrderlyDifferentialOrderlyVariableEliminationOrderTools : TestCaseType with {

#include "cs_dvoeo.test.signatures.as"
