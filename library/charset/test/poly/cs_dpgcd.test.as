...
local EPR == DistributivePolynomialRingSubResultantPRSGcdDomainExtension( R, VARS, EXP, OPR, OPRRT );


TestDistributivePolynomialRingSubResultantPRSGcdDomainExtension: TestCaseType with {

#include "cs_polyi.test.signatures.as"
#include "cs_polyw.test.signatures.as"
#include "cs_gcd.test.signatures.as"
#include "cs_dpgcd.test.signatures.as"
