...
TestDistributivePolynomialRingIntegralDomainExtensionField: TestCaseType with {

#include "cs_polyi.test.signatures.as"
#include "cs_polyw.test.signatures.as"
#include "cs_dpidt.test.signatures.as"
#include "cs_dpidf.test.signatures.as"

} == TestDistributivePolynomialRingIntegralDomainExtension( R, VARS, [ VAR1, VAR2, VAR3 ], EXP, CPR, OPR ) add {
