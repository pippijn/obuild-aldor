...
TestDifferentialPolynomialReductionTools1 : TestCaseType with {

#include "cs_dpred.test.signatures.as"
#include "cs_dpre1.test.signatures.as"
	...
	assertTrue( reducedBy?Func( var101 ) );
	...
	local var310: DPR := variable( 3, [ 1, 0 ] ) :: DPR;
	local reducedBy?Func := reducedBy?( var101*var110*var300+var310*var200 );
	assertTrue( reducedBy?Func( var111*var300 ) );
	...
	local var300: DPR := variable( 3, [ 0, 0 ] ) :: DPR;
	local var310: DPR := variable( 3, [ 1, 0 ] ) :: DPR;
	assertTrue( reduced?( var101, var101*var110*var300+var310*var200 ) );
	...
	local var300: DPR := variable( 3, [ 0, 0 ] ) :: DPR;
	local var310: DPR := variable( 3, [ 1, 0 ] ) :: DPR;
	assertTrue( reduced?( var111*var300, var101*var110*var300+var310*var200 ) );
    }
	...
	assertEquals( DPR, reduceStepFunc( (5::DFLD)*var100*var211+var202*var202*var202*var100 ), (5::DFLD)*var100*var211+var202*var202*var202*var100 );
