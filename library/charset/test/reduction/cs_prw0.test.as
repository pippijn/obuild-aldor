...
local RT    == PolynomialReductionWithoutDivisionTools( DFLD, DVARS, EXP, DPR );
...
TestPolynomialReductionWithoutDivisionTools0 : TestCaseType with {

#include "cs_prwd.test.signatures.as"
#include "cs_prw0.test.signatures.as"

} == TestPolynomialReductionWithoutDivisionTools( DFLD, DVARS, DPR, RT, VARP ) add {
