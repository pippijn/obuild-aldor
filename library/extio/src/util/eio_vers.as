...
macro PATCHVERSION ==  0;
macro DESCRIPTION ==  "A library for extending the input/output capabilities";
macro NAME ==  "ExtIO";
macro CREDITS ==  [  "Christian Aistleitner" ];
macro REQUIREDLIBRARIES ==  [  "Aldor" , "Algebra" ];

#include "aldor"

+++\begin{addescription}{provides information about \projectname in machine readable form.}
+++\end{addescription}
ExtIOLibraryInformation : VersionInformationType with {
	...
	requiredLibraries == REQUIREDLIBRARIES;
        version == {
		local versionString : String := new 10;
		(versionString :: TextWriter) << major << "." << minor << "." << patch;
		versionString;
	}
	name == NAME;
	credits == CREDITS;
