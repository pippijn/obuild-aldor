...
macro VALUE == String;
macro TABLE == ChainingHashTableWithCustomHashFunction( KEY, VALUE, hash$KEY );

TestChainingHashTableWithCustomHashFunction : TestCaseType with {

#include "eio_htt.test.signatures.as"
#include "eio_chtc.test.signatures.as"
